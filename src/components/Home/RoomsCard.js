            ...
            <div className="p-5">
                ...
                <div className='flex justify-between'>
                    <p className='flex my-auto'>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 640 512" color='gray'>
                    ...
                    <Link to='/booking'>
                        <button type="button" className="text-white hover:text-cyan-900 bg-primary hover:bg-[#e0b035] rounded-md focus:outline-none font-medium -lg text-lg px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Book</button>
                    </Link>
                </div>
            </div>
        </div>
